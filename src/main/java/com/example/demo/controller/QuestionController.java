...
public class QuestionController {
    ...
    public List<QuestionEntity> findQuestion_list(String open_id,int book_id)
    ...
    public String insert_Question(String type,int point_id,String stem,String choices,String answer,String explanation,String open_id)
    {
